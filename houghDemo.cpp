...
{
    // Read the image
    String imageName( "E:/alex/Air Hockey Robot/aidenbot2/AidenBot/data/vid2754.jpg" ); // by default
    if( argc > 1 )
    {
        imageName = argv[1];
    }
...
void Probabilistic_Hough( int, void* )
{
    ...
    HoughLinesP( edges, p_lines, 1, CV_PI / 180, min_threshold + p_trackbar, 30, 50 );
